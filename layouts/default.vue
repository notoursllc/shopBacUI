            ...
            <div class="layout-sidenav-content">
                ...
                <div class="grow px-2">
                    <navigation-list text-color="#484747">
                        ...
                        <navigation-item :route="{ name: 'exchange_rates' }">
                            <!-- <template v-slot:icon>
                                <fig-icon
                                    icon="coin"
                                    :width="22"
                            ...
                            <span class="nav-item-main">{{ $t('Exchange rates') }}</span>
                        </navigation-item>

                        <navigation-item :route="{ name: 'account' }">
                            <!-- <template v-slot:icon>
                                <fig-icon
                                    icon="coin"
                                    :width="22"
                            ...
                            <span class="nav-item-main">{{ $t('Account') }}</span>
                        </navigation-item>
